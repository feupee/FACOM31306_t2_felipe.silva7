...
public abstract class ContaBancaria implements Imprimivel {
    ...
    public void adicionarCliente(Cliente cliente) {
        if (clientes[0].equals(cliente)) {
            System.out.println("Cliente já está associado como titular.");
            return;
        }

        if (clientes[1] != null) {
            if (clientes[1].equals(cliente)) {
                System.out.println("Cliente já está associado como conjunto.");
            } else {
    ...
    public void removerCliente(Cliente cliente) {
        if (clientes[0] != null && clientes[0].equals(cliente)) {
            ...
            clientes[1] = null;
            System.out.println("Titular removido. Cliente conjunto promovido a titular.");
        } else if (clientes[1] != null && clientes[1].equals(cliente)) {
            clientes[1] = null;
            System.out.println("Cliente conjunto removido.");
        } else {
            System.out.println("Cliente não está associado a esta conta.");
        }
    }
